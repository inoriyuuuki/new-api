...
var channelReadOnlyFields = map[string]struct{}{
	...
	"used_quota":            {},
	"credential_profile_id": {}, // managed exclusively via the credential profile binding endpoints
}
...
func clearChannelReadOnlyFields(channel *PatchChannel, requestData map[string]any) {
	...
	if _, ok := requestData["credential_profile_id"]; ok {
		channel.CredentialProfileId = nil
	}
}
