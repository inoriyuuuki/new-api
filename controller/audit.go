...
var auditContentTemplates = map[string]string{
	...
	"channel.credential_refresh":         "Refreshed credentials for ${succeeded}/${total} channels with tag ${tag}",
	"channel.credential_refresh_preview": "Previewed credential refresh for ${succeeded}/${total} channels with tag ${tag}",
	"channel.credential_profile_create":  "Created credential profile ${name} (ID: ${id})",
	"channel.credential_profile_update":  "Updated credential profile ${name} (ID: ${id})",
	"channel.credential_profile_delete":  "Deleted credential profile ${name} (ID: ${id})",
	"channel.credential_profile_bind":    "Bound credential profile ${name} (ID: ${id}) to ${added} channels and unbound ${removed}",
	"channel.credential_profile_apply":   "Applied credential profile ${name} (ID: ${id}) to ${succeeded}/${total} channels",
	"channel.credential_profile_preview": "Previewed credential profile ${name} (ID: ${id}) for ${succeeded}/${total} channels",
