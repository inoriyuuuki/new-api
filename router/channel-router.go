...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodPost, path: "/credential-refresh", permission: authz.ChannelSensitiveWrite, handler: controller.RefreshChannelCredentials},
	{method: http.MethodGet, path: "/credential-profiles", permission: authz.ChannelRead, handler: controller.GetCredentialProfiles},
	{method: http.MethodPost, path: "/credential-profiles", permission: authz.ChannelSensitiveWrite, handler: controller.CreateCredentialProfile},
	{method: http.MethodGet, path: "/credential-profiles/:id", permission: authz.ChannelRead, handler: controller.GetCredentialProfile},
	{method: http.MethodPut, path: "/credential-profiles/:id", permission: authz.ChannelSensitiveWrite, handler: controller.UpdateCredentialProfile},
	{method: http.MethodDelete, path: "/credential-profiles/:id", permission: authz.ChannelSensitiveWrite, handler: controller.DeleteCredentialProfile},
	{method: http.MethodGet, path: "/credential-profiles/:id/channels", permission: authz.ChannelRead, handler: controller.GetCredentialProfileChannels},
	{method: http.MethodPut, path: "/credential-profiles/:id/channels", permission: authz.ChannelSensitiveWrite, handler: controller.SetCredentialProfileChannels},
	{method: http.MethodPost, path: "/credential-profiles/:id/apply", permission: authz.ChannelSensitiveWrite, handler: controller.ApplyCredentialProfile},
