...
describe('API key group table cell', () => {
  ...
  test('renders one unclipped ratio ring with localized Auto copy when API data uses a nonlocalized string', async () => {
  ...
  test('omits Auto effects when ratio data is unavailable', async () => {
    const container = document.createElement('div')
    document.body.append(container)
    const root = createRoot(container)
